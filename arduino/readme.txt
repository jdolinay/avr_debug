...
Arduino package used: 1.6.5-r2

Your project should define AVR_DEBUG symbol in AVR Compiler  > Symbols.
...
-------
File: WInterrupts.c   
Modification: section for INT0 interrupt placed into #if AVR_DEBUG section.
Reason: This allows building the project with this debugger which uses INT0 interrupt itself.
