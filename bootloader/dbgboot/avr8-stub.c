...
// prototypes from optiboot.c
uint8_t getch(void);
void putch(char ch);
/*  Prototypes of internal functions */
#define getDebugChar getch
#define putDebugChar(a) putch(a)
...
void debug_init(void)
{
	/* Init gdb context */
	gdb_ctx = &ctx;
	memset(gdb_ctx, 0, sizeof(struct gdb_context));

	// old verze kde nuluje postupne jednotlive
#if 0
	gdb_ctx = &ctx;
	gdb_ctx->sp = 0;
...
// TODO: make it blocking - disable interrupts?
__attribute__ ((naked))
